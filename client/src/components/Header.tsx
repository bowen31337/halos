  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Recent Items button */}
        <div className="relative">
          <Tooltip content="Recent items" shortcut="Ctrl+H">
            <button
              onClick={() => setRecentItemsOpen(!recentItemsOpen)}
              className="p-2 hover:bg-[var(--surface-elevated)] rounded-lg transition-colors relative"
          ...
          {/* Recent Items Menu */}
          <RecentItemsMenu
            isOpen={recentItemsOpen}
            onClose={() => setRecentItemsOpen(false)}
          />
        </div>
